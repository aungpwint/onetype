...
describe('setting value sanitization', () => {
    it('passes valid values through unchanged', () => {
        ...
        expect(sanitizeSettingValue('practice.unit', 'quote')).toBe('quote')
        expect(sanitizeSettingValue('practice.unit', 'text')).toBe('text')
    ...
    it('coerces out-of-range and malformed values to their default', () => {
        ...
        expect(sanitizeSettingValue('practice.unit', 'endless')).toBe('time')
