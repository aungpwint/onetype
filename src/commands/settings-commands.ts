...
export const SETTING_COMMANDS: SettingCommandDef[] = [
    { id: 'punctuation', title: 'Practice punctuation', keywords: 'add punctuation marks comma full stop', settingKey: 'practice.punctuation', toggle: true },
    ...
    { id: 'hide-extra-letters', title: 'Hide extra letters', keywords: 'only show current word', settingKey: 'practice.hideExtraLetters', toggle: true },
