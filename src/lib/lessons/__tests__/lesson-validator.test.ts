...
import { parseLesson, validateLesson } from "../lesson-validator";
...
describe("validateLesson", () => {
  ...
  it("rejects corrupt behavioural fields with accumulated issues", () => {
    const raw = { ...canonicalLesson(), number: -3, language: "fr", level: "master", keyboard: "klingon", completion: { minAccuracy: 130, minWpm: "fast" } } as unknown;
