...
const SETTINGS_SECTIONS: SettingsEntry[] = [
    ...
    {
        id: 'typing-experience',
        type: 'section',
        label: 'Typing experience',
    ...
    { id: 'practice', type: 'section', label: 'Practice', section: 'Practice', keywords: ['sound', 'finger', 'focus', 'goal'] },
    {
        ...
        keywords: ['keys', 'hotkeys', 'shortcut', 'restart'],
    },
...
const SETTINGS_ITEMS: SettingsEntry[] = [
    ...
    { id: 'blind-mode', type: 'item', label: 'Blind mode', section: 'Typing experience', keywords: ['hide', 'upcoming', 'blind'] },
    {
        ...
        label: 'Caret style',
        section: 'Typing experience',
        keywords: ['cursor', 'bar', 'block', 'line', 'underline'],
    },
    ...
    { id: 'hand-guide', type: 'item', label: 'Hand guide', section: 'Practice', keywords: ['finger', 'next', 'hands', 'guide'] },
    {
        ...
        section: 'Practice',
        keywords: ['keyboard', 'keys', 'on-screen', 'keycap', 'show', 'hide'],
    },
    { id: 'focus-mode', type: 'item', label: 'Focus mode', section: 'Practice', keywords: ['minimal', 'hide header', 'zen'] },
    {
        id: 'confirm-exit',
        type: 'item',
        label: 'Confirm before abandoning a round',
        section: 'Practice',
        keywords: ['exit', 'abandon', 'confirm', 'leave'],
    },
    {
        id: 'focus-guard',
        type: 'item',
        label: 'Pause when you leave the window',
        section: 'Practice',
        keywords: ['out of focus', 'blur', 'pause', 'window'],
    },
    {
        id: 'indicate-typos',
        type: 'item',
        label: 'How mistakes are shown',
        section: 'Practice',
        keywords: ['errors', 'mistakes', 'underline', 'replace', 'typos'],
    },
    {
        id: 'daily-goal',
        type: 'item',
...

    {
        ...
        keywords: ['os', 'native', 'alerts', 'on', 'off'],
    },
