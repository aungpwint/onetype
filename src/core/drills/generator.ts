...
import type { DrillConfig, WordList } from './types'
...
export function generateRepetitionDrill(keys: string[], repeats: number, separator: string = ' '): GeneratedDrill {
    const out: string[] = []
    for (const k of keys) {
...
export function generatePairDrill(pairs: [string, string][], repeats: number, separator: string = ' '): GeneratedDrill {
    const out: string[] = []
...
export function generateAlternationDrill(leftKeys: string[], rightKeys: string[], pairsCount: number): GeneratedDrill {
    const out: string[] = []
...
export function generateSameHandDrill(keys: string[], groupSize: number, groups: number): GeneratedDrill {
    const out: string[] = []
...
export function generateShiftSentenceDrill(words: string[]): GeneratedDrill {
    const out: string[] = []
...
export function generateNumberDrill(digits: string[], length: number): GeneratedDrill {
    const out: string[] = []
    for (let i = 0; i < length; i++) {
...
export function generateAlternatingNumberDrill(leftDigits: string[], rightDigits: string, pairsCount: number): GeneratedDrill {
    const out: string[] = []
    for (let i = 0; i < pairsCount; i++) {
...
export function generateWordDrill(wordList: WordList, count: number, seed: number = 42): GeneratedDrill {
...
export function generateRowTransitionDrill(homeRowKeys: string[], otherRowKeys: string[], pairsCount: number): GeneratedDrill {
    const out: string[] = []
